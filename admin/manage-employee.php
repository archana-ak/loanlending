...
if(isset($_GET['status11']))
{
	$status1=$_GET['status11'];
...
{
?>
<td><a href="manage-employee.php?status=<?php echo $row->id;?>"  onclick="return confirm('Do you want to Activate &nbsp;<?php echo $row->name;?>');">Activate</a></td><?php }
//$status=$row->status;
if($status=='Active')
{
?>
<td><a href="manage-employee.php?status11=<?php echo $row->id;?>"  onclick="return confirm('Do you want to Deactivate &nbsp;<?php echo $row->name;?>');">Deactivate</a></td>
<?php } ?>
