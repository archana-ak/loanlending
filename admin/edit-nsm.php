...
$sql=mysqli_query($mysqli,"Update nsm set name='$full_name', role='$role',bank_name='$bank_name',product_name='$product_name',office_no='$office_no',personal_no='$personal_no',
email='$mail_ID',email_personal='$mail_ID_personal',join_date='$join_date',address='$address',status='$status' where id='$id'");
...
{
  echo "<script>alert('NSM has been Updated successfully');</script>";
}
}
?>
<!doctype html>
    ...
    <div class="content-wrapper">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
          <br>
            <h2 class="page-title">Edit NSM </h2>
  
            <div class="row">
              <div class="col-md-12">
                <div class="panel panel-default">
                  <div class="panel-heading">Edit NSM</div>
                  <div class="panel-body">
                    <form method="post" class="form-horizontal">

                          <?php 
                        $id=$_GET['id'];
  $ret="select * from nsm where id=?";
