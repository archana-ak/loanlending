...
$status=$_POST['status'];
$nsm=$_POST['nsm'];
$sql=mysqli_query($mysqli,"insert into zsm
  (name,role,bank_name,product_name,office_no,personal_no,email,email_personal,join_date,state,address,status,nsm_name,nsmid) 
  values
  ('$full_name','$role','$bank_name','$product_name','$office_no','$personal_no','$mail_ID','$mail_ID_personal','$join_date','$state1','$address','$status','$nsm','$nsm')");
if(!$sql)
{
    ...
    <div class="content-wrapper">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
          <br>
            <h2 class="page-title">Add Manager (ZSM)</h2>
 ...
 <?php
  ...
  <div class="form-group">
    ...
    <label for="lname"  class="col-sm-1 control-label">Mail ID </label>
	 <div class="col-sm-2">
    <input type="email" id="lname" name="mail_ID" class="form-control" placeholder="Office" required="required" onclick="ValidateEmail(mail_ID)">
	</div>
  ...
  <label for="lname"  class="col-sm-1 control-label">Mail ID </label>
   <div class="col-sm-2">
    <input type="email" id="lname" name="mail_ID_personal" class="form-control" placeholder="Personal"  required="required" onclick="ValidateEmail(mail_ID)">
	 ...
	 <label for="lname"  class="col-sm-1 control-label">Office Number</label>
   <div class="col-sm-2">
    <input type="tel" id="lname" name="Office_no" class="form-control"  required="required"   >
	</div>
	
	   <label for="lname"  class="col-sm-1 control-label">Personal number</label>
   <div class="col-sm-2">
...
<select multiple="multiple" class="form-control" onChange="getState(this.value);"  
