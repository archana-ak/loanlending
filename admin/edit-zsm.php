...
$sql=mysqli_query($mysqli,"Update zsm set name='$full_name', role='$role',bank_name='$bank_name',product_name='$product_name',office_no='$office_no',personal_no='$personal_no',
email='$mail_ID',email_personal='$mail_ID_personal',join_date='$join_date',
state='$state',address='$address',status='$status',nsm_name='$nsm',nsmid='$nsm' where id='$id'");
...
{
  echo "<script>alert('ZSM has been Updated successfully');</script>";
}
}
?>
<!doctype html>
    ...
    <div class="content-wrapper">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
          <br>
            <h2 class="page-title">Edit ZSM </h2>
  
            <div class="row">
              <div class="col-md-12">
                <div class="panel panel-default">
                  <div class="panel-heading">Edit ZSM</div>
                  <div class="panel-body">
                    <form method="post" class="form-horizontal">

                          <?php 
                        $id=$_GET['id'];
  $ret="select * from zsm where id=?";
...
<div class="col-sm-2">
  ...
  <input type="tel" id="lname" name="personal_no" class="form-control"  value="<?php echo $row->personal_no;?>"   required="required"  >
   ...
   <label for="lname" class="col-sm-1 control-label">Mail ID </label>
      <div class="col-sm-2">
    <input type="email" id="lname" name="mail_ID"  value="<?php echo $row->email;?>" class="form-control"  placeholder="Office" required="required" onclick="ValidateEmail(mail_ID)">
	</div>
  
  
  <label for="lname"  class="col-sm-1 control-label">Mail ID</label>
  <div class="col-sm-2">
    <input type="email" id="lname" name="mail_ID_personal" value="<?php echo $row->email_personal;?>"  class="form-control" placeholder="Personal"  required="required" onclick="ValidateEmail(mail_ID)">
	</div>
