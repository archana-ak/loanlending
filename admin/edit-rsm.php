...
$sql=mysqli_query($mysqli,"Update rsm set name='$full_name', role='$role',bank_name='$bank_name',product_name='$product_name',office_no='$office_no',personal_no='$personal_no',
email='$mail_ID',email_personal='$mail_ID_personal',join_date='$join_date',state='$state',hub='$hub',city='$city',address='$address',status='$status',zsm_name='$zsm',nsm_name='$nsm',zsmid='$zsm',nsmid='$nsm' where id='$id'");
...
{
  echo "<script>alert('RSM has been Updated successfully');</script>";
}
}
?>
<!doctype html>
    ...
    <div class="content-wrapper">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
          <br>
            <h2 class="page-title">Edit RSM </h2>
  
            <div class="row">
              <div class="col-md-12">
                <div class="panel panel-default">
                  <div class="panel-heading">Edit RSM</div>
                  <div class="panel-body">
                    <form method="post" class="form-horizontal">

                          <?php 
                        $id=$_GET['id'];
  $ret="select * from rsm where id=?";
...
<div class="col-sm-2">
  ...
  <div class="form-group">
   ...
   <div class="col-sm-2">
    <input type="tel" id="lname" name="Office_no"  value="<?php echo $row->office_no;?>" class="form-control"  required="required"   >
	</div>
	
	<label for="lname" class="col-sm-1 control-label">Personal No</label>
   <div class="col-sm-2">
	
  <input type="tel" id="lname" name="personal_no"  value="<?php echo $row->personal_no;?>"  class="form-control" required="required"  >
  </div>
   ...
   <label for="lname"  class="col-sm-1 control-label">Mail ID </label>
     <div class="col-sm-2">
    <input type="email" id="lname" name="mail_ID"  value="<?php echo $row->email;?>"  placeholder="Office"  class="form-control" required="required" onclick="ValidateEmail(mail_ID)"></div>
  ...
  <div class="col-sm-2">
   ...
   <label for="country"  class="col-sm-1 control-label">HUB</label>
   <div class="col-sm-2">
...
{
?>
    <option value="<?php echo htmlentities($row1['id']);?><?php echo htmlentities($row1['name']);?>"<?php $r=$row->zsm_name; //print_r($r);die();
...
{
?>
   <option value="<?php echo htmlentities($row2['id']);?><?php echo htmlentities($row2['name']);?>"<?php $r=$row->nsm_name; //print_r($r);die();
