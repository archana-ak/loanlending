		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
					<br>
						<h2 class="page-title">Count Call Records</h2>
...
<label class="col-sm-1 control-label">Tele Sales Executive Name</label> <div class="col-sm-2">
...
$edate=$_POST['edate'];
$ename=$_POST['ename'];
$ret="select * from customer where c_date BETWEEN '$sdate' and '$edate' and calledby='$ename'";
