...
$status=$_POST['status'];
$sql=mysqli_query($mysqli,"insert into nsm
  (name,role,bank_name,product_name,office_no,personal_no,email,email_personal,join_date,address,status) 
  values
  ('$full_name','$role','$bank_name','$product_name','$office_no','$personal_no','$mail_ID','$mail_ID_personal','$join_date','$address','$status')");
if(!$sql)
{
    ...
    <div class="content-wrapper">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
          <br>
            <h2 class="page-title">Add Manager (NSM)</h2>
