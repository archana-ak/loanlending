...
$ret="select * from customer where date BETWEEN '$sdate' and '$edate' group by addedby";
				...
				<form action="export_call_record/excel.php" method="post">
...
<?php 
   $sql="select count(addedby) as c from customer where date BETWEEN '$sdate' and '$edate' and addedby='$row->addedby'";
...
<td>
<a href="javascript:void(0);"  onClick="popUpWindow('https://device.digitalzilla.xyz/admin/print-record.php?id=<?php echo $row->id;?>&count=<?php echo $r->c;?>&sdate=<?php echo $sdate;?>&edate=<?php echo $edate;?> ');" title="View Full Details"><i class="fa fa-desktop"></i></a></td>
