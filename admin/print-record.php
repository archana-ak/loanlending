...
<?php 
       ...
       // $c=$_GET['edate'];print_r($c);die();
			...
			<tr>
			  <td colspan="2"  class="font"><?php echo ucfirst($row['addedby']);?>'S <span class="font1"> information &raquo;</span> </td>
  </tr>
			<tr>
      ...
      <tr>
        <td colspan="2"  class="heading" style="color: red;">Records Added Related Info &raquo; </td>
  </tr>
      <tr>
        <td colspan="2"  class="font1"><table width="100%" border="0">
                <tr>
                  ...
                  <td width="22%" valign="top" class="heading">Ending Date : </td>
                    ...
                    <tr>
                  <td width="22%" valign="top" class="heading">No of Records Added : </td>
